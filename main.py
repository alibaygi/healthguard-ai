"""
Main Execution Entry Point for HealthGuard AI.

This file is the "control center" that starts and manages the entire 
health claims audit workflow. Think of it as the master switch that:
...
logging.basicConfig(
    ...
    # Example: "2024-01-15 10:30:45 - healthguard - INFO - Starting audit"
)
logger = logging.getLogger("healthguard-runner")  # Creates a named logger for this module
...
def run_cli_simulation():
    ...
    initial_inputs = {
        # The TikTok/YouTube video to audit for health claims
        "video_url": "https://www.tiktok.com/@drjasonf/video/7349282018498686254",
