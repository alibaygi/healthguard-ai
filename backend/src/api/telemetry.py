...
logger = logging.getLogger("healthguard-telemetry")
# Example log output: "healthguard-telemetry - INFO - Azure Monitor enabled"
...
def setup_telemetry():
    ...
    try:
        ...
        configure_azure_monitor(
            ...
            logger_name="healthguard-tracer"   # Optional: custom tracer name
        )
        # 
